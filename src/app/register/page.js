      ...
      <div className="flex min-h-full flex-1 flex-col justify-center mt-[5%] md:mt-0 px-6 py-12 lg:px-8">
        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Sudah Punya Akun?{' '}
            <Link href="/login" className="block font-semibold leading-6 text-secondary hover:opacity-90">
              Kalau Sudah Silahkan Login
            </Link>
          </p>
          <Link href="/" className='block text-center mt-9 rounded-md text-white font-semibold bg-secondary px-3 py-1.5 mx-auto text-sm w-40 '>Kembali Ke Home</Link>
        </div>
      </div>
    </>
  )
