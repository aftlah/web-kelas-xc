...
const Navbar = () => {
  const data = localStorage.getItem('nim')
  ...
  return (
    <>
      <nav className='h-[4.5rem] bg-primary bottom-0 fixed w-full'>
        <ul className='flex justify-between p-4 text-white font-semibold '>
          <li>
            {
              data ? (
