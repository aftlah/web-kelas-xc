    ...
    <>
      ...
      <nav className='h-[5rem] bg-primary bottom-0 fixed w-full'>
        <ul className='flex justify-between items-center  py-4 px-10  text-white font-semibold '>
          <li className={`mt-1 ${pathname == '/tugas' ? 'scale-110' : 'opacity-80'} `}>
          ...
          <li className={` mt-1 ${pathname == '/' ? 'scale-110' : 'opacity-80'} `}>
          ...
          <li className={` mt-1 ${pathname == '/anggota' ? 'scale-110' : 'opacity-80'} `}>
