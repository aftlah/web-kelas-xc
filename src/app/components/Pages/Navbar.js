...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='h-[5rem] bg-primary bottom-0 fixed w-full sm:block sm:h-full sm:w-[7rem] '>
      <Image src='/images/logo-putih.png' alt='logo' width={200} height={200} className='w-16 h-auto mt-6 mx-auto hidden sm:block' />
        <ul className='flex justify-between items-center  py-4 px-10  text-white font-semibold sm:flex-col sm:gap-y-10 sm:w-full sm:px-2 '>
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-gray-800 sm:w-full ${pathname == '/tugas' ? 'scale-110' : 'opacity-75'} `}>
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-gray-800 sm:w-full ${pathname == '/' ? 'scale-110' : 'opacity-75'} `}>
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-gray-800 sm:w-full ${pathname == '/anggota' ? 'scale-110' : 'opacity-75'} `}>
