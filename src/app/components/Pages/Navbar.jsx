    ...
    <>
      ...
      <Image src='/images/logo-putih.png' alt='logo' width={200} height={200} className='w-[5.5rem] h-auto mt-4 mx-auto hidden sm:block  sm:mb-6' />
        <ul className='flex justify-between items-center  py-4 px-10  text-white font-semibold sm:flex-col sm:gap-y-7 sm:w-full sm:px-2 '>
          <li className={`mt-1 w-10 sm:border-b-2 border-white sm:w-full hidden sm:block  `}>
          {
              data && data.length > 0 ? (
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-white sm:w-full ${pathname == '/tugas' ? 'scale-110' : 'opacity-75'} `}>
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-white sm:w-full ${pathname == '/' ? 'scale-110' : 'opacity-75'} `}>
          ...
          <li className={`mt-1 w-10 sm:border-b-2 border-white sm:w-full ${pathname == '/anggota' ? 'scale-110' : 'opacity-75'} `}>
